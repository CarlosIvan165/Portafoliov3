...
@section('contenido')
        ...
        <div class="grid items-center justify-center h-150 content-center text-center fondo">
            <div class="hidden md:flex flex-col absolute p-4 shadow-xl/20 bg-[#2D2D2D]">
                ...
                <a href="https://wa.me/525525211102"
                    ...
                    target="_blank"
                    rel="noopener noreferrer"><i class="fa-brands fa-whatsapp fa-2xl my-6"></i>
                </a>              
            </div>
    ...
    <section id="acerca" class="grid place-items-center text-center px-4">
        <h1 class="text-3xl font-bold mb-6">Acerca de mí</h1>

        <!-- Texto -->
        <div class="w-full max-w-6xl">
            <div class="my-7 text-lg p-5 text-justify space-y-5">
                <p>
                    Soy Carlos Iván Pérez Benítez, desarrollador web con experiencia en la creación y mantenimiento de sitios web.
                    He trabajado como freelancer y en entornos empresariales usando HTML, CSS, JavaScript, PHP, SQL y WordPress.
                    Como Webmaster en iló living, gestioné catálogos, promociones y colaboré en diseño visual.
                    También tengo experiencia en desarrollo de plugins, integraciones de pago (OpenPay, PayPal),
                    recuperación de contraseñas personalizada y manejo de bases de datos.
                </p>

                <p>
                    Me gusta resolver problemas prácticos, optimizar procesos y aprender constantemente nuevas herramientas,
                    como Laravel, para seguir creciendo profesionalmente. Además, tengo un fuerte interés en la seguridad web,
                    respaldos, migraciones y el diseño de interfaces claras.
                </p>
            </div>
        </div>

        <!-- Habilidades -->
        <div class="my-7 w-full max-w-4xl">
            <h1 class="text-3xl font-bold text-center mb-6">Mis habilidades</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-2 justify-center">
                        <span class="px-2 py-1 rounded bg-gradient-to-b from-[#228B5C] from-35% to-[#02462E] to-90% rounded">HTML</span>
                        <span class="px-2 py-1 rounded bg-gradient-to-b from-[#228B5C] from-35% to-[#02462E] to-90% rounded">CSS</span>
                        <span class="px-2 py-1 rounded bg-gradient-to-b from-[#228B5C] from-35% to-[#02462E] to-90% rounded">SASS</span>
                        <span class="px-2 py-1 rounded bg-gradient-to-b from-[#228B5C] from-35% to-[#02462E] to-90% rounded">JavaScript</span>
                        <span class="px-2 py-1 rounded bg-gradient-to-b from-[#228B5C] from-35% to-[#02462E] to-90% rounded">Blade</span>
                        <span class="px-2 py-1 rounded bg-gradient-to-b from-[#228B5C] from-35% to-[#02462E] to-90% rounded">Tailwind CSS</span>
                        <span class="px-2 py-1 rounded bg-gradient-to-b from-[#228B5C] from-35% to-[#02462E] to-90% rounded">Livewire</span>
                        <span class="px-2 py-1 rounded bg-gradient-to-b from-[#228B5C] from-35% to-[#02462E] to-90% rounded">Responsive Design</span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-2 justify-center">
                        <span class="px-2 py-1 rounded bg-gradient-to-b from-[#228B5C] from-35% to-[#02462E] to-90% rounded">PHP</span>
                        <span class="px-2 py-1 rounded bg-gradient-to-b from-[#228B5C] from-35% to-[#02462E] to-90% rounded">Laravel</span>
                    </div>
                </div>

                <div>
                    <h3 class="text-xl font-semibold mb-3">CMS</h3>
                    <div class="flex flex-wrap gap-2 justify-center">
                        <span class="px-2 py-1 rounded bg-gradient-to-b from-[#228B5C] from-35% to-[#02462E] to-90% rounded">WordPress</span>
                    </div>
                </div>

                <div>
                    <h3 class="text-xl font-semibold mb-3">Base de Datos</h3>
                    <div class="flex flex-wrap gap-2 justify-center">
                        <span class="px-2 py-1 rounded bg-gradient-to-b from-[#228B5C] from-35% to-[#02462E] to-90% rounded">MySQL</span>
                    </div>
                </div>

                <div>
                    <h3 class="text-xl font-semibold mb-3">Control de Versiones</h3>
                    <div class="flex flex-wrap gap-2 justify-center">
                        <span class="px-2 py-1 rounded bg-gradient-to-b from-[#228B5C] from-35% to-[#02462E] to-90% rounded">Git</span>
                        <span class="px-2 py-1 rounded bg-gradient-to-b from-[#228B5C] from-35% to-[#02462E] to-90% rounded">GitHub</span>
                    </div>
                </div>
    ...
    <section id="proyectos" class="mt-15 grid items-center justify-center content-center text-center" id="proyectos">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 text-left gap-5">
            ...
            <div class="w-80">
                <img class="w-full rounded-t-lg" src="{{ asset('img/echoblog/echoblog.png') }}" alt="proyecto CafeShop">
                <div class="p-3 bg-[#474747] rounded-b-lg ">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-white">EchoBlog</h5>
                    <p class="mb-3 font-normal text-white">Proyecto personal</p>
                    <a href="{{ route('echoblog') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-gradient-to-b from-[#228B5C] from-35% to-[#02462E] to-90%">
                        Saber mas
                    </a>
                </div>
            </div>
